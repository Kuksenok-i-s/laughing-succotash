...
| `handwriting-ocr/` | Deploy unit D — optional; OvisOCR2 handwriting OCR via llama.cpp on a GPU host |
...
llama.cpp (`llama-server`) on the OCR host, with no local fallback. See
