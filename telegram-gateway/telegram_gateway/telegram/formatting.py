...
ERROR_TEXT = {
    ...
    "ocr_unavailable": "Разбор фотографии сейчас недоступен.",
    "ocr_failed": "Не удалось разобрать фотографию.",
    "image_too_large": "Изображение слишком большое.",
    "invalid_image": "Это не изображение.",
...
STAGE_TEXT = {
    ...
    "recognizing": "Смотрю фотографию…",
    "recognizing_album": "Смотрю фотографии…",
    "structuring": "Проверяю и структурирую текст…",
    "summarizing": "Разбираю…",
    "agent": "Думаю…",
