...
Transcription runs locally on the Core host with `faster-whisper`, default model `large-v3`. The
...
host where two concurrent large-v3 transcriptions would thrash rather than parallelise.
