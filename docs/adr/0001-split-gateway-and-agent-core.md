...
projects, calendar and contacts live, which is the Core host. Those are different machines
with very different exposure: the VPS accepts traffic from the public internet, the Core host holds
